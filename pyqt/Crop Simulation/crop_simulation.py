...
class CropWindow(QMainWindow):
    """this class creates a main window to observe the growth of a simulation crop"""

    #constructor
    def __init__(self):
        super().__init__() #call supper class constructor
    ...
    def create_view_crop_layout(self, crop_type):
        ...
        self.status_grid.addWidget(self.day_line_edit,1,1)
        self.status_grid.addWidget(self.status_line_edit,2,1)

        #add widgets/layouts to the new grow layout
    ...
    def instantiate_crop(self):
        ...
        self.stacked_layout.addWidget(self.view_crop_widget) # add this to the stak
    ...
    def update_crop_view_status(self):
        crop_status_report = self.simulated_crop.report() #get the report

        #update the text fields
        self.growth_line_edit.setText(str(crop_status_report["growth"]))
        self.day_line_edit.setText(str(crop_status_report["days growing"]))
...
def main():
    ...
    crop_window.raise_() #raise instance to top window stack

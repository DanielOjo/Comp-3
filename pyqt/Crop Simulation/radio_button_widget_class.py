...
class RadioButtonWidget(QWidget):
    ...
    #constructor
    def __init__(self, label, instructor, button_list):
        super().__init__() #call the super class constuctor

        #creates widgets
        self.title_label = QLabel(label)
        self.radio_group_box = QGroupBox(instructor)
        ...
        #creates a layout for a whole widget
